...
//                   this.__rowArr.length + " rows");
    ...
    setRowNoSelection: function(rowIndex, rowData, view)
    {
      this.__setRowNoSelection(/*columnIndex*/ -1, rowIndex, rowData, view);
    },
    __setRowNoSelection: function(columnIndex, rowIndex, V, view)
    {
      if (view === undefined)
      {
        view = this.getView();
